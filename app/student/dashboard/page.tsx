    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          Here's an overview of your coaching progress
        </p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="text-2xl font-bold">
              {sessions
                ? `${sessions.used_sessions} / ${sessions.total_sessions}`
                : "0 / 0"}
            </div>
            <Progress
              value={
                sessions
                  ? (sessions.used_sessions / sessions.total_sessions) * 100
                  : 0
              }
              className="h-2"
            />
      ...
      <Card>
        ...
        <CardContent>
          <a
            href="https://tidycal.com/meetwudi/30-minutes-meeting"
            target="_blank"
            rel="noopener noreferrer"
            className="mr-2 inline-flex items-center justify-center rounded-md bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90"
          >
            Schedule a 30-minute session
          </a>
          <a
            href="https://tidycal.com/meetwudi/60-minutes-meeting"
            target="_blank"
            rel="noopener noreferrer"
